...
class KillTracker:
    ...
    def handle_regular_kill(self):
        ...
        if self.time.last_kill_time and not self.time.multi_kill_expired:
            self.self.time.multi_kill_window_expired()
    ...
    def handle_test_mode(self):
        ...
        self.expiration_thread = threading.Thread(target=check_expirations, daemon=True)
    ...
    def handle_live_mode(self):
        ...
        # Start thread to check for config updates
